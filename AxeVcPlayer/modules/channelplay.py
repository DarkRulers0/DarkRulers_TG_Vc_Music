...
from AxeVcPlayer.config import BOT_NAME as bn
from AxeVcPlayer.config import DURATION_LIMIT
from AxeVcPlayer.config import UPDATES_CHANNEL as updateschannel
from AxeVcPlayer.config import que
from AxeVcPlayer.helpers.admins import get_administrators
from AxeVcPlayer.helpers.decorators import authorized_users_only
from AxeVcPlayer.helpers.gets import get_file_name
from AxeVcPlayer.modules.play import arq, cb_admin_check, generate_cover
from AxeVcPlayer.services.callsmusic import callsmusic
from AxeVcPlayer.services.callsmusic import client as USER
from AxeVcPlayer.services.converter.converter import convert
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/159bd948d895523f46a7e.jpg"
        ...
        try:
            ...
            if (dur / 60) > DURATION_LIMIT:
                await lel.edit(
                    f"❌ Videos longer than 10 minutes aren't allowed to play!"
                )
                return
        except:
            pass
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @AxeVcPlayer to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/159bd948d895523f46a7e.jpg"
